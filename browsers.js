...
browser('r','Tor','tor','wml','https://www.torproject.org/dist/torbrowser/'+vtor+'/torbrowser-install-win64-'+vtor+'_ALL.exe','https://www.torproject.org/dist/torbrowser/'+vtor+'/TorBrowser-'+vtor+'-macos_ALL.dmg','https://www.torproject.org/dist/torbrowser/'+vtor+'/tor-browser-linux64-'+vtor+'_ALL.tar.xz');
